        ...
        <div class="container-fluid pt-5">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-2 maincontent">
                ...
                <div class="justify-content-between align-items-center pt-1 pb-2 mb-3 border-bottom mx-2">
                    <h5 class="h5 mt-3 mb-0 color-darkgray"> PDS | <small>Father's information</small></h5>
                </div>
                <!-- end title -->
                <!-- container-fluid -->
                                    ...
                                    <form action="<?=site_url('Hr/add_department');?>" method="POST">
                                         ...
                                         <div class="col-md-12 mb-2">
                                            ...
                                            <input type="text" name="FATHNAM3"
                                                ...
                                                data-placement="right" title="First Name" >
                                            ...
                                            <input type="text" name="FATHOCCUP"
                                                ...
                                                data-placement="right" title="Occupation" >

        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-2 maincontent">
                ...
                <div class="justify-content-between align-items-center pt-1 pb-2 mb-3 border-bottom mx-2">
                    <h5 class="h5 mt-3 mb-0 color-darkgray"> Add User  <small>Profile</small></h5>
                </div>
                <!-- end title -->
                                ...
                                <div class="col-md-12 p-2 float-sm-start">
                                    <div class="card">
                                        ...
                                        <div class="card-body accordion-collapse collapse show"
                                            ...
                                            <div class="col-md-12 mb-2">
                                                <label for="permanentaddress" class="form-label">Residential
                                                    Address*</label> /
                                            ...
                                            <div class="col-md-12">
                                                <div class="profile-img">
                                                    ...
                                                    <div class="file btn btn-lg btn-primary" >
                                                        ...
                                                        <input id="signature" type="file" data-toogle="tooltip" title="Edit Your Picture" onchange="readURL(this);"/>
                                                        <i class="fa fa-camera"  aria-hidden="true"></i>

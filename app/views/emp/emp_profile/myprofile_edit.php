                            ...
                            <div class="col-lg-12 col-xlg-12 col-md-12">
                                <div class="card">
                                    ...
                                    <!-- <ul class="nav nav-tabs profile-tab" role="tablist">
                                        ...
                                        <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#education" role="tab" style="font-size: 14px;"> Educational Background</a> </li>

                                        <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#eligibility" role="tab" style="font-size: 14px;"> Civil Service Eligibility</a> </li>


                                        <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#experience" role="tab" style="font-size: 14px;">Work Experience</a> </li>

                                        <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#" role="tab" style="font-size: 14px;">Voluntary Work</a> </li>
                                        <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#" role="tab" style="font-size: 14px;">Trainings Programs Attended</a> </li>
                                        <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#" role="tab" style="font-size: 14px;">Other Information</a> </li>

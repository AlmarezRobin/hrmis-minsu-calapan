    ...
    <div class="container px-0 mx-3">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-center topbarcss">
            ...
            <a href="" class="d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none logotext">
                ...
                <span style="color:#3bbf0f"><b style="color:#ffd900">HUMAN RESOURCE</b> MINSU</span>
            </a>
            ...
            <ul class="social-links">
                ...
                <a href="https://www.instagram.com/" class="text-white pb-0 mb-0 mx-2"> <i class="fa fa-instagram"></i>
                </a>
                <a href="https://www.twitter.com/" class="text-white pb-0 mb-0 mx-2"> <i class="fa fa-twitter"></i> </a>
                <a href="https://www.youtube.com/" class="text-white pb-0 mb-0 mx-2"> <i class="fa fa-youtube"></i> </a>
            </ul>
...
<!-- <header class="py-2 bg-dark text-white fixed-top px-0  ">
    <div class="container px-0 mx-3">
        ...
        <div class="d-flex flex-wrap align-items-left justify-content-left topbarcss"> -->
            ...
            <!-- <form action="" class="col-12 col-lg-auto mb-3 mb-lg-0 me-0 justify-content-left d-flex searchform" method="POST"> -->

                <!-- <button class="navbar-toggler d-md-none collapsed " type="button" data-bs-toggle="collapse" data-bs-target="#sidebarMenu" aria-controls="sidebarMenu" aria-expanded="false" aria-label="Toggle navigation">
                        <span class="text-white"> <i class="fa fa-icon fa-bars"></i> </span>
                    </button>
                
                <label for=""class="ms-2" style="font-size: 20px;color:#fff">HUMAN RESOURCE</label> -->
            <!-- </form> -->
...
<!-- <style>
     .back{
        background-image: url('<?php echo BASE_URL .  PUBLIC_DIR ?>/public/img/header.jpg');

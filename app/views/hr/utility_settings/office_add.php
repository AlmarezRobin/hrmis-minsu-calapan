                        ...
                        <div class="d-flex justify-content-center">
                            <div class="card">
                                ...
                                <div class="card-body accordion-collapse collapse show" id="collapseTable-d">
                                    <form action="<?=site_url('Utility_Settings/add_office');?>" method="POST">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-2">
                                                ...
                                                <input type="text" class="form-control form-control-sm" name="office_code" id="" required>
                                            </div>
                                            <div class="col-md-12 mb-2">
                                                <label for="f1" class="form-label">Office Description</label>
                                                <input type="text" class="form-control form-control-sm" name="office_description" id="" required>
                                            </div>

                        ...
                        <div class="col-md-12 p-2 float-sm-start">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <a href="<?=site_url('Utility_Settings/add_employment_status');?>" data-toogle="tooltip" title="EDIT STATUS" > <i class="fa fa-icon fa-edit fa-lg pull-right"></i> </a>
                                </div>
                                            ...
                                            <tbody>
                                                <?php foreach($data as $datum) : ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="<?= site_url('Utility_Settings/get_single_emp_stat')?>" method="post" class="d-inline">
                                                                <input type="hidden" name="status_id" value="<?= $datum['status_id']?>">
                                                                <button class="btn btn-mini btn-success">
                                                                <i class="fa fa-pencil" aria-hidden="true"></i>
                                                                </button>
                                                            </form>
                                                            <form action="<?= site_url('Utility_Settings/delete_emp_stat')?>" method="post" class="d-inline">
                                                                <input type="hidden" name="status_id" value="<?= $datum['status_id']?>">

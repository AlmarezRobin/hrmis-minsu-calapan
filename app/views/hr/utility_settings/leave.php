                        ...
                        <div class="col-md-12 p-2 float-sm-start">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header">
                                    ...
                                    List of Departments
                                    <a href="<?=site_url('Utility_Settings/leave_add');?>" c data-toogle="tooltip" title="ADD LEAVE" > <i class="fa fa-icon fa-plus fa-lg pull-right"></i> </a>
                                                ...
                                                <?php foreach($data as $datum) : ?>
                                                    <tr>
                                                        ...
                                                        <form action="<?= site_url('Utility_Settings/leave_delete')?>" method="post" class="d-inline">
                                                            ...
                                                            <form action="<?= site_url('Utility_Settings/get_single_leave')?>" method="post" class="d-inline">
                                                                <input type="hidden" name="leave_id" value="<?= $datum['leave_id']?>">

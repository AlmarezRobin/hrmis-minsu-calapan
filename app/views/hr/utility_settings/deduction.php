                        ...
                        <div class="col-md-12 p-2 float-sm-start">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header">
                                    ...
                                    List of Deductions
                                    <a href="<?= site_url('Hr/add_deduction'); ?>" data-toogle="tooltip" title="ADD DEDUCTIONS" > <i class="fa fa-icon fa-plus fa-lg pull-right"></i> </a>
                                            ...
                                            <tbody>
                                                <?php foreach ($data as $datum) : ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="<?= site_url('hr/delete_deduction') ?>" method="post" class="d-inline">
                                                            ...
                                                            <form action="<?= site_url('hr/get_single_deduction') ?>" method="post" class="d-inline">
                                                                <input type="hidden" name="deduction_id" value="<?= $datum['deduction_id'] ?>">

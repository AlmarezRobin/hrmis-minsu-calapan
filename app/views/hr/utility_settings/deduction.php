                        ...
                        <div class="col-md-12 p-2 float-sm-start">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header">
                                    ...
                                    List of Deductions
                                    <a href="<?= site_url('Utility_Settings/add_deduction'); ?>" data-toogle="tooltip" title="ADD DEDUCTIONS" > <i class="fa fa-icon fa-plus fa-lg pull-right"></i> </a>
                                        ...
                                        <table id="example2" class="table table-bordered table-hover table-striped table-sm" style="overflow:hidden;">
                                            ...
                                            <tbody>
                                                <?php foreach ($data as $datum) : ?>
                                                    <tr>
                                                        <td> <?php echo $datum['deduction_id']  ?></td>
                                                        <td> <?php echo $datum['deduction_name'] ?></td>
                                                        <td> <?php echo $datum['deduction_base_amount'] ?></td>
                                                        <td>
                                                            <form action="<?= site_url('Utility_Settings/delete_deduction') ?>" method="post" class="d-inline">
                                                            ...
                                                            <form action="<?= site_url('Utility_Settings/get_single_deduction') ?>" method="post" class="d-inline">
                                                                <input type="hidden" name="deduction_id" value="<?= $datum['deduction_id'] ?>">

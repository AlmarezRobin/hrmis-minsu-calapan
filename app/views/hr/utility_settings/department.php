                        ...
                        <div class="col-md-12 p-2 float-sm-start">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header">
                                    ...
                                    List of Departments
                                    <a href="<?=site_url('Utility_Settings/add_department');?>"  data-toogle="tooltip" title="ADD DEPARTMENT" > <i class="fa fa-icon fa-plus fa-lg pull-right"></i> </a>
                                            ...
                                            <tbody>
                                                <?php foreach($data as $datum) : ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="<?= site_url('Utility_Settings/delete_department')?>" method="post" class="d-inline">
                                                            ...
                                                            <form action="<?= site_url('Utility_Settings/get_single_dept')?>" method="post" class="d-inline">
                                                                <input type="hidden" name="dept_id" value="<?= $datum['dept_id']?>">

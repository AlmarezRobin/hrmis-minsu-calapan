                        ...
                        <div class="col-md-12 p-2 float-sm-start">
                            <div class="card">
                                ...
                                <div class="card-header">
                                    ...
                                    <a href="<?=site_url('Utility_Settings/add_designation');?>"  data-toogle="tooltip" title="ADD DESIGNATIONS" > <i class="fa fa-icon fa-plus fa-lg pull-right"></i> </a>
                                            ...
                                            <tbody>
                                                <?php foreach($data as $datum) : ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="<?= site_url('Utility_Settings/delete_designation')?>" method="post" class="d-inline">
                                                            ...
                                                            <form action="<?= site_url('Utility_Settings/get_single_designation')?>" method="post" class="d-inline">
                                                                <input type="hidden" name="designation_id" value="<?= $datum['designation_id']?>">

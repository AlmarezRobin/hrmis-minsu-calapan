                        ...
                        <div class="col-md-12 p-2 float-sm-start">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    List of Offices
                                    <a href="<?=site_url('Utility_Settings/add_office');?>"  data-toogle="tooltip" title="ADD OFFICE" > <i class="fa fa-icon fa-plus fa-lg pull-right"></i> </a>
                                            ...
                                            <tbody>
                                                <?php foreach($data as $datum) : ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="<?= site_url('Utility_Settings/delete_office')?>" method="post" class="d-inline">
                                                            ...
                                                            <form action="<?= site_url('Utility_Settings/get_single_office')?>" method="post" class="d-inline">
                                                                <input type="hidden" name="office_id" value="<?= $datum['office_id']?>">

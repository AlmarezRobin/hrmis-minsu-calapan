...
class Employee_model extends Model{
   ...
   public function sess_log($username){
      ...
      return $this->db->table('user')->select('user.user_id, user.id_number, user.role, user_profile.profile_id user_profile.f_name, user_profile.m_name, user_profile.l_name, user_profile.name_ex, user_profile.date_of_birth, user_profile.sex, user_profile.civil_status, user_profile.telephone, user_profile.mobile')->inner_join('user_profile', 'user.user_id = user_profile.user_id')->where($bind)->get();
   }
